...
def set_env_settings(generator, args):
    if args.env == "robocasa":
        ...
        generator.add_param(
            ...
            group=-1,
            values=[
                {"crop_height": 200, "crop_width": 200, "num_crops": 1, "pos_enc": False},
            ],
            hidename=True,
        )
...
def get_robocasa_ds(
    ...
    from robocasa.utils.dataset_registry import get_ds_path, SINGLE_STAGE_TASK_DATASETS, MULTI_STAGE_TASK_DATASETS, DC24_TASK_DATASETS, DC5_TASK_DATASETS
    ...
    all_datasets.update(DC24_TASK_DATASETS)
    all_datasets.update(DC5_TASK_DATASETS)
    if ds_names == "all":
        ...
        ds_names = list(DC24_TASK_DATASETS.keys())
    elif ds_names == "dc5":
        ds_names = list(DC5_TASK_DATASETS.keys())
